...
1. The participant enters a name and mobile number before the game. A separate optional checkbox offers an invitation to an upcoming Saturday Youth Evening through the WhatsApp group.
...
- `youth-signup` stores the name, mobile number, optional WhatsApp invitation choice and an anonymous participant ID. Submission happens in the background so a slow connection does not block the game from starting.
